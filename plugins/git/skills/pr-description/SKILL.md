...
- Start bullets with strong verbs such as `Add`, `Remove`, `Update`, `Align`, or `Refactor`; bold action words only if the user asks for that style or the existing PR description already uses it.
